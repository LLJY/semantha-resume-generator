...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Copy manual context overlay markdown files into a central data/context directory."
    )
    parser.add_argument(
        "--source-root",
        required=True,
        help="Root directory to search for context markdown files",
    )
    parser.add_argument(
        "--output-dir",
        default="data/context",
        help="Destination directory for normalized context markdown",
    )
